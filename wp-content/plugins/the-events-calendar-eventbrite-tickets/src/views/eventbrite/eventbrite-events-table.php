...
<tr>
	<td class="tec-ebt-table__label"><?php esc_html_e( 'Eventbrite Event Privacy', 'tribe-eventbrite' ) ?>:</td>
	<td>
		<?php
	...
	<tr>
		<td colspan="2" class="snp_sectionheader">
			<table class="EB-table">
				<tr>
					<td width="120px" class="tec-ebt-table__label"><?php esc_attr_e( 'Ticket', 'tribe-eventbrite' ); ?></td>
					<td width="85px" class="tec-ebt-table__label"><?php esc_attr_e( 'Cost', 'tribe-eventbrite' ) ?></td>
					<td width="40px" class="tec-ebt-table__label"><?php esc_attr_e( 'Sold', 'tribe-eventbrite' ); ?></td>
					<td width="40px" class="tec-ebt-table__label"><?php esc_attr_e( 'Available', 'tribe-eventbrite' ); ?></td>
					<td width="100px" class="tec-ebt-table__label"><?php esc_attr_e( 'End Sales', 'tribe-eventbrite' ); ?></td>
				</tr>
			...
			<?php } ?>
				<tr>
					<td class="tec-ebt-table__tickets">
						<a id="edit-ticket" href="<?php echo esc_url( 'https://www.eventbrite.com/myevent?eid=' . $event->id . '/#viewtickets' ) ?>"><?php esc_attr_e( 'Edit existing tickets', 'tribe-eventbrite' ) ?></a>
