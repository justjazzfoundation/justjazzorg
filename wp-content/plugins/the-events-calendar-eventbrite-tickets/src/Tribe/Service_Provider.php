...
use Tribe\Events\Eventbrite\Admin;
use Tribe\Events\Eventbrite\Import\Image;
...
class Tribe__Events__Tickets__Eventbrite__Service_Provider extends tad_DI52_ServiceProvider {
	...
	public function register() {
		...
		$this->container->singleton( 'eventbrite.migrate', 'Tribe__Events__Tickets__Eventbrite__Migrate', [ 'hook' ] );
		$this->container->singleton( 'eventbrite.migrate.queue', 'Tribe__Events__Tickets__Eventbrite__Migrate__Queue' );
		$this->container->singleton( 'eventbrite.admin', Admin::class );
		$this->container->singleton( 'eventbrite.import.image', Image::class, [ 'hook' ] );
	...
	protected function hook() {
		...
		add_filter( 'tribe_aggregator_template_file', tribe_callback( 'eventbrite.admin', 'overwrite_templates' ), 10, 3 );
		add_filter( 'tribe_aggregator_build_url_data', tribe_callback( 'eventbrite.aggregator', 'add_license_data'), 10, 2  );
	}
