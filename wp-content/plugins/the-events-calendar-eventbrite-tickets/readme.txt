...
For those who want an introduction to how Eventbrite Tickets or the core The Events Calendar works, check out our <a href="https://evnt.is/39">new user primers.</a>
...
Please visit the forum for questions or comments: https://evnt.is/3a
...
But wait: there's more! We've got a whole stable of plugins available to help you be awesome at what you do. Check out a full list of the products below, and over at the <a href="https://evnt.is/3c">The Events Calendar website.</a>
...
* Version - Eventbrite Tickets 4.6.11 is only compatible with The Events Calendar 5.15.0 and higher
* Feature - Add compatibility to the new TEC admin menu system. [ET-1335]

= [4.6.10] 2022-03-17 =

* Tweak - Improve the look and feel of the Eventbrite metabox section within the add/edit event page. [EBT-125]
* Tweak - Changed views: `eventbrite/eventbrite-events-table`, `eventbrite/eventbrite-meta-box-extension`

= [4.6.9] 2021-11-17 =

* Fix - Correct an unescaped "%" in a sprintf that can cause fatals. [EBT-119]
* Language - 0 new strings added, 1 updated, 0 fuzzied, and 0 obsoleted

= [4.6.8] 2021-02-24 =

* Fix - Compatibility with WordPress 5.7 and jQuery 3.5.X
* Language - 0 new strings added, 51 updated, 0 fuzzied, and 1 obsoleted

= [4.6.7] 2021-02-02 =

* Fix - Prevent errors when using `Cron` as mechanism for imports. [EBT-107]

= [4.6.6] 2020-12-02 =

* Tweak - Changed language: "Leave this event associated with eventbrite.com?" to "Sync this event to eventbrite.com when updating?" [EBT-83]
* Tweak - Changed views: `eventbrite/eventbrite-meta-box-extension`
* Fix - Choosing to not sync updates to Eventbrite will now retain its setting. [EBT-83]
* Fix - Choosing to not sync updates to Eventbrite no longer removes the setting to show tickets. [EBT-83]
* Language - 28 new strings added, 72 updated, 0 fuzzied, and 1 obsoleted

= [4.6.5] 2020-06-24 =

* Fix - Update of events when your owned events are updated on Eventbrite. [EBT-85]
* Fix - When the price changes on your imported events the changes updates are reflected back to your imported events. [EBT-85]
* Tweak - Import the featured images of the events on the background to prevent crashes on larger set of images [EBT-89]
* Tweak - Extend views from The Events Calendar into Eventbrite plugin to allow updates directly into the plugin instead [EBT-77]

= [4.6.4] 2020-02-24 =

* Tweak: Add Notice when PRO is not activated to inform venue address inconsistencies on Eventbrite [EBT-39]
* Tweak - Reduced file size by removing .po files and directing anyone creating or editing local translations to translations.theeventscalendar.com [EBT-61]
* Tweak - Changed views: `eventbrite/eventbrite-meta-box-extension`
* Language - 1 new strings added, 27 updated, 0 fuzzied, and 0 obsoleted

= [4.6.3] 2019-10-16 =

* Fix - Dependency checker now correctly identifies missing Event Tickets on activation or deactivation of Event Tickets with The Events Calendar active [131722]
