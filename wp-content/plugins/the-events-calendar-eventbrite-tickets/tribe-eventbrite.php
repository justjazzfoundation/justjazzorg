...
/*
Copyright 2009-2012 by The Events Calendar and the contributors
...
require_once dirname( EVENTBRITE_PLUGIN_FILE ) . '/vendor/autoload.php';
...
function tribe_events_tickets_eventbrite_init() {
	...
	$plugins_check = tribe_check_plugin( 'Tribe__Events__Tickets__Eventbrite__Main' );
